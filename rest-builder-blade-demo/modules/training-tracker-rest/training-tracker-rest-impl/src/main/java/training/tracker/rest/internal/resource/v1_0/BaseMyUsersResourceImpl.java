...
public abstract class BaseMyUsersResourceImpl implements MyUsersResource {

	/**
	 * Invoke this method with the command line:
	 *
	 * curl -X 'GET' 'http://localhost:8080/o/training-tracker-rest/v1.0/myusers'  -u 'test@liferay.com:test'
	 */
	@io.swagger.v3.oas.annotations.tags.Tags(
		value = {@io.swagger.v3.oas.annotations.tags.Tag(name = "MyUsers")}
	)
	@javax.ws.rs.GET
	@javax.ws.rs.Path("/myusers")
	...
	private static final com.liferay.portal.kernel.log.Log _log =
		LogFactoryUtil.getLog(BaseMyUsersResourceImpl.class);
