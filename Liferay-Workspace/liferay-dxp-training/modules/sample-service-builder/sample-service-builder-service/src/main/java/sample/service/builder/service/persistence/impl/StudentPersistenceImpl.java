...
import sample.service.builder.exception.NoSuchStudentException;
import sample.service.builder.model.Student;
import sample.service.builder.model.StudentTable;
import sample.service.builder.model.impl.StudentImpl;
import sample.service.builder.model.impl.StudentModelImpl;
import sample.service.builder.service.persistence.StudentPersistence;
import sample.service.builder.service.persistence.StudentUtil;
import sample.service.builder.service.persistence.impl.constants.CollinsPersistenceConstants;
...
public class StudentPersistenceImpl
	...
	@Override
	@Reference(
		target = CollinsPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = CollinsPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
