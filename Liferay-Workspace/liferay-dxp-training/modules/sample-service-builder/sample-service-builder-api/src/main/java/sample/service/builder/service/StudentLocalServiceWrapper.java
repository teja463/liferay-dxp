...
public class StudentLocalServiceWrapper
	 ...
	 */
	@Override
	public sample.service.builder.model.Student addStudent(
		sample.service.builder.model.Student student) {
	 ...
	 */
	@Override
	public sample.service.builder.model.Student createStudent(long id) {
	 ...
	 */
	@Override
	public sample.service.builder.model.Student deleteStudent(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public sample.service.builder.model.Student deleteStudent(
		sample.service.builder.model.Student student) {
	...
	@Override
	public sample.service.builder.model.Student fetchStudent(long id) {
	 ...
	 */
	@Override
	public sample.service.builder.model.Student getStudent(long id)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<sample.service.builder.model.Student> getStudents(
		int start, int end) {
	 ...
	 */
	@Override
	public sample.service.builder.model.Student updateStudent(
		sample.service.builder.model.Student student) {
